...
void C_Button::draw() {
	render::get().gradient(area.x, area.y, area.w, 20, Color{ 30, 30, 30, 255 }, Color(24, 24, 24, 255), GRADIENT_VERTICAL);
	...
	render::get().rect(area.x, area.y, area.w, 20, Color(60, 60, 60, 255));
	render::get().rect(area.x - 1, area.y - 1, area.w + 2, 22, Color(10, 10, 10, 255));

	render::get().text(fonts[GROUPBOX], area.x + 10, area.y + 10, Color::White, HFONT_CENTERED_Y, label.c_str());
}
