...
void C_SliderInt::draw() {
	...
	render::get().text(fonts[TAHOMA12], n_area.x - 7, n_area.y - 2, Color(60, 60, 60), HFONT_CENTERED_NONE, ("-"));
	render::get().text(fonts[TAHOMA12], n_area.x + 3 + area.w, n_area.y - 2, Color(60, 60, 60), HFONT_CENTERED_NONE, ("+"));
