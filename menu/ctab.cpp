...
void C_Tab::paint() {
	...
	render::get().text(fonts[WATERMARK], tab_area.x + 8, tab_area.y + 10, Color::Grey, HFONT_CENTERED_Y, name.c_str());
	...
	if (index == menu::get().selected_tab) {
		...
		render::get().text(fonts[CTAB], tab_area.x + 8, tab_area.y + 10, Color(255, 255, 255), HFONT_CENTERED_Y, name.c_str());
