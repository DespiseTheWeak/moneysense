...
//-----------------------------------------------------------------------------
// pStruct = the base structure of the datatable this variable is in (like entity_t)
// pOut    = the variable that this this proxy represents (like entity_t::m_SomeValue).
//
