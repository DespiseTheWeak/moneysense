...
void render::setup() {
	...
	fonts[SKOPECROSSHAIR] = create_font("cherryfont", 67, FW_NORMAL, FONTFLAG_DROPSHADOW);
	fonts[AIMTABICON] = create_font("cherryfont", 12, FW_NORMAL, FONTFLAG_DROPSHADOW);
	fonts[rolexTEXT] = create_font("Segoe UI Emoji", 12, FW_BOLD, FONTFLAG_DROPSHADOW);
	fonts[rolexBOLD] = create_font("Segoe UI Emoji", 12, FW_BOLD, FONTFLAG_OUTLINE);
	fonts[ESPFLAG] = create_font(/*"Open Sans Semibold"*/"Verdana", 12, FW_HEAVY, FONTFLAG_OUTLINE | FONTFLAG_ANTIALIAS);
	fonts[TAHOMA12] = create_font("Tahoma", 12, FW_NORMAL, FONTFLAG_OUTLINE);
	fonts[MENUNAME] = create_font("Segoe UI Emoji", 15, FW_THIN, FONTFLAG_OUTLINE);
	fonts[VERDANA12] = create_font("Segoe UI Emoji", 12, FW_NORMAL, FONTFLAG_NONE);
	fonts[VERDANA12OUT] = create_font("Segoe UI Emoji", 12, FW_NORMAL, FONTFLAG_OUTLINE);
	fonts[VERDANA12BOLD] = create_font("Segoe UI Emoji", 12, FW_BOLD, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW);
	fonts[VERDANA12BOLDOUT] = create_font("Segoe UI Emoji", 12, FW_BOLD, FONTFLAG_ANTIALIAS | FONTFLAG_OUTLINE);
	fonts[ESPNAME] = create_font(/*"Open Sans Semibold"*/"Verdana", 11, FW_HEAVY, FONTFLAG_OUTLINE | FONTFLAG_ANTIALIAS);
	fonts[ESPHEALTH] = create_font("Segoe UI Emoji", 12, FW_THIN, FONTFLAG_OUTLINE);
	fonts[WEAPONICONS] = create_font("astriumwep", 10, FW_MEDIUM, FONTFLAG_ANTIALIAS | FONTFLAG_OUTLINE);
	fonts[GRENADEICONS] = create_font("astriumwep", 27, FW_MEDIUM, FONTFLAG_ANTIALIAS | FONTFLAG_OUTLINE);
	fonts[SUBTABWEAPONS] = create_font("astriumwep", 10, FW_MEDIUM, FONTFLAG_ANTIALIAS);
	fonts[INDICATORFONT] = create_font("Open Sans Semibold", 20, FW_BOLD, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW);
	fonts[INDICATORFONT2] = create_font("Open Sans Semibold", 25, FW_BOLD, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW);
	fonts[TABFONT] = create_font("Vermin Vibes Regular", 12, FW_NORMAL, FONTFLAG_ANTIALIAS);
	fonts[rolexFONT] = create_font("RedCore", 40, FW_NORMAL, FONTFLAG_ANTIALIAS);
	fonts[SLIDERFONT] = create_font("Return of the Grid", 12, 800, FONTFLAG_ANTIALIAS);
	fonts[NYAFONT] = create_font("Return of the Grid", 12, FW_NORMAL, FONTFLAG_OUTLINE);
	fonts[BIGVERMIN] = create_font("Vermin Vibes Regular", 50, FW_MEDIUM, FONTFLAG_ANTIALIAS);
	fonts[WATERMARK] = create_font("Tahoma", 11, FW_MEDIUM, FONTFLAG_DROPSHADOW);
	fonts[GROUPBOX] = create_font("Verdana", 12, 800, FONTFLAG_ANTIALIAS);
	fonts[ICONS] = create_font("Aurora", 50, FW_MEDIUM, FONTFLAG_DROPSHADOW);
	fonts[AIMWAREFONT] = create_font("Calibri", 11, FW_NORMAL, FONTFLAG_DROPSHADOW);
	fonts[CTAB] = create_font("Verdana", 12, 700, FONTFLAG_DROPSHADOW);
	fonts[CATICON] = create_font("blobtabs", 12, FW_NORMAL, FONTFLAG_DROPSHADOW);
}
...
void render::nonamegey(int x, int y, Color color, DWORD font, std::string Input)
{
